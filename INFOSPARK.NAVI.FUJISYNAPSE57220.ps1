...
Add-Member -InputObject $MassDriver -MemberType 'ScriptMethod' -Name 'FujiSynapseCopy' -Force -Value {
...
Invoke-Command -ScriptBlock {
    ...
    Write-Host -Object $(' 2. Install Fuji Synapse 5.7.220 Web (PROD)')
    Write-Host -Object $(' 3. Install Fuji Synapse 5.7.220 Desktop Agent (TEST)')
    Write-Host -Object $(' 4. Install Fuji Synapse 5.7.220 Web (EXT)')
    Write-Host -Object $('==============================================================================')
    Write-Host -Object $(' 5. Repair Fuji Synapse 5.7.220')
    Write-Host -Object $(' 6. Uninstall Fuji Synapse 5.7.220')
    Write-Host -Object $('==============================================================================')
    ...
    SWITCH ($ActionInput) {
        ...
        '2' {$MassDriver.FujiSynapseInstallWebPROD($TargetInput)}
        '5' {$MassDriver.FujiSynapseRepair($TargetInput)}
        '6' {$MassDriver.FujiSynapseUninstall($TargetInput)}
        DEFAULT {RETURN}
    }
}